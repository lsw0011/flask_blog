...
def register():
	...
	if form.validate_on_submit():
		...
		db.session.add(user)
		db.session.commit()
		flash('Your account created! You are now able to login!', 'success')
...
def user_posts(username):
	...
	return render_template('user_posts.html', posts = posts, user = user) #posts becomes available in the home.html template
